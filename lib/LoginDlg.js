...
LoginDlg = function (opts) {
    ...
    me._dlg = $('#' + me._logindiv).html(
        ...
        + " <input id='" + me._userID + "' value='zhuge' class='ui-corner-all login_form' name='username' type='text' placeholder='请输入您的用户名'/><br>"
        + " <label for='password'>密码</label><br>"
        + " <input id='" + me._passwdID + "' value='123456' class='ui-corner-all login_form' name='password' type='password' placeholder='请输入您的密码'/><br>"
